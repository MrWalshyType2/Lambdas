...
public class App {
	...
	public static void main(String args[]) {
		...
		Consumer.ConsumerMath addition = (num1, num2) -> { return num1 + num2; };
		Consumer.ConsumerMath subtraction = (num1, num2) -> { return num1 - num2; };
		Consumer.ConsumerMath multiplication = (num1, num2) -> { return num1 * num2; };
		Consumer.ConsumerMath division = (num1, num2) -> { return num1 / num2; };
